# -*- coding: utf-8 -*-
"""
Created on Sat Aug 18 00:35:41 2018
...
log_dir = 'C:\\Users\\quent\\practice\\sexrecog\\logs'

checkpoint_file = 'D:\\CR_Pelvic_Check\\inception_resnet_v2_2016_08_30.ckpt'

image_size = 250

num_classes = 2

labels_to_name = {0:"female",1:"male"}


file_pattern = 'image_%s_*.tfrecord'

items_to_descriptions = {
    'image': 'A x-ray pelvic image of a patient.',
    'label': 'A label that is as such -- 0:female, 1:male'
}
...
#============== DATASET LOADING ======================
def get_split(split_name, dataset_dir, file_pattern=file_pattern, file_pattern_for_counting='image'):
    '''
